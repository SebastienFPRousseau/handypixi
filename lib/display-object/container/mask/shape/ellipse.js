...
class Ellipse extends Shape {
   ...
   * @param {Number}  halfWidth  The half width of this ellipse.
   * @param {Number}  halfHeight  The half height of this ellipse.
  ...
  constructor(
    ...
    if ({}.toString.call(halfWidth) !== "[object Number]") {
      throw new TypeError("halfWidth must be a number.");
    }

    if ({}.toString.call(halfHeight) !== "[object Number]") {
      throw new TypeError("halfHeight must be a number.");
    }
    ...
    if (x instanceof PIXI.Ellipse) {
      ...
      this._properties = new PIXI.Ellipse(x, y, halfWidth, halfHeight);
    }
