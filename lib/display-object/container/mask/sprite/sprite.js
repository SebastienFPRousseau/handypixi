...
class Sprite extends Mask {
  ...
  constructor(pixiObj = null) {
    ...
    if (pixiObj instanceof PIXI.Sprite) this._out = pixiObj;
    else this._out = new PIXI.Sprite(PIXI.Texture.EMPTY);
  }
   ...
   */
  set anchor(anchor) {
    if (!(anchor instanceof ObservablePoint))
      throw new TypeError("anchor must be a ObservablePoint.");
