...
const { Star } = require("./mask/shape/Star.js");
...
class ShapeFactory extends AbstractContainerFactory
{
	 ...
	 */
	createStar(x = undefined, y = undefined, pointsNumber = undefined, radius = undefined, options = undefined, nativeLines = undefined)
	{
