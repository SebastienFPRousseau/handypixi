 ...
 */
  ...
  */
	destroy(options) {
		if (!(typeof options === "object" && {}.toString.call(options) === "[object Object]") && {}.toString.call(options) !== "[object Boolean]") throw new TypeError("options must be an object or a boolean.");
  ...
  */
	setTransform(transform) {
		if (!(typeof transform === "object" && {}.toString.call(transform) === "[object Object]")) throw new TypeError("transform must be an object.");
