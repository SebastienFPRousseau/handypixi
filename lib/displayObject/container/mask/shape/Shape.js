 ...
 */
  ...
  */
	arc(params) {
		if (!(typeof params === "object" && {}.toString.call(params) === "[object Object]")) throw new TypeError("params must be an object.");
  ...
  */
	bezierCurveTo(points) {
		if (!(typeof points === "object" && {}.toString.call(points) === "[object Object]")) throw new TypeError("points must be an object.");
  ...
  */
	lineStyle(style) {
		if (!(typeof style === "object" && {}.toString.call(style) === "[object Object]")) throw new TypeError("style must be an object.");
