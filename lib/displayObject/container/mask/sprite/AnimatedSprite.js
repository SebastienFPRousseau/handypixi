 ...
 */
  ...
  */
	onComplete(onComplete) {
		if ({}.toString.call(onComplete) !== "[object Function]") throw new TypeError("onComplete must be a function.");
  ...
  */
	onFrameChange(onFrameChange) {
		if ({}.toString.call(onFrameChange) !== "[object Function]") throw new TypeError("onFrameChange must be a function.");
