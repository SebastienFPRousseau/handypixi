...
class Emitter
{
	...
	set alpha(alpha)
	{
		if (!(typeof alpha === "object" && {}.toString.call(alpha) === "[object Object]"))
		...
		{
			if (!(typeof alpha.list[i] === "object" && {}.toString.call(alpha.list[i]) === "[object Object]"))
				throw new TypeError("alpha.list elements must be objects.");

			if ({}.toString.call(alpha.list[i].value) !== "[object Number]")
				throw new TypeError("value attribute in an alpha.list element must be a number.");

			if ({}.toString.call(alpha.list[i].time) !== "[object Number]")
				throw new TypeError("time attribute in an alpha.list element must be a number.");
		}
	...
	set color(color)
	{
		if (!(typeof color === "object" && {}.toString.call(color) === "[object Object]"))
		...
		{
			if (!(typeof color.list[i] === "object" && {}.toString.call(color.list[i]) === "[object Object]"))
				throw new TypeError("color.list elements must be objects.");

			if (!(typeof color.list[i].value === "string" && {}.toString.call(color.list[i].value) === "[object String]"))
				throw new TypeError("value attribute in a color.list element must be a String hex value.");

			if ({}.toString.call(color.list[i].time) !== "[object Number]")
				throw new TypeError("time attribute in an color.list element must be a number.");
		}
	...
	set scale(scale)
	{
		if (!(typeof scale === "object" && {}.toString.call(scale) === "[object Object]"))
		...
		{
			if (!(typeof scale.list[i] === "object" && {}.toString.call(scale.list[i]) === "[object Object]"))
				throw new TypeError("scale.list elements must be objects.");

			if ({}.toString.call(scale.list[i].value) !== "[object Number]")
				throw new TypeError("value attribute in an scale.list element must be a number.");

			if ({}.toString.call(scale.list[i].time) !== "[object Number]")
				throw new TypeError("time attribute in an scale.list element must be a number.");
		}
	...
	set speed(speed)
	{
		if (!(typeof speed === "object" && {}.toString.call(speed) === "[object Object]"))
		...
		{
			if (!(typeof speed.list[i] === "object" && {}.toString.call(speed.list[i]) === "[object Object]"))
				throw new TypeError("speed.list elements must be objects.");

			if ({}.toString.call(speed.list[i].value) !== "[object Number]")
				throw new TypeError("value attribute in an speed.list element must be a number.");

			if ({}.toString.call(speed.list[i].time) !== "[object Number]")
				throw new TypeError("time attribute in an speed.list element must be a number.");
		}
