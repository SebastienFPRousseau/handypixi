...
class Particle extends Sprite {
  ...
  */
	constructor(emitter) {
		...
		if (this.constructor !== Particle) return;
  ...
  */
	set extraData(extraData) {
		if (!(typeof extraData === "object" && {}.toString.call(extraData) === "[object Object]")) throw new TypeError("extraData must be an object.");
  ...
  */
	constructor(parent, textures, config = undefined) {
		if (parent instanceof PIXI.particles.Emitter) {
			...
			if (!(typeof config === "object" && {}.toString.call(config) === "[object Object]" || config === undefined)) throw new TypeError("config must be an object.");
