...
class MouseEventListener extends EventListener
{
	...
	constructor(obj, code, handle, data = {})
	{
		...
		let eventListener = new PixiMouseEventListener(obj, PixiMouseEventListener.MOUSE_OVER, this.mouseOver, this);
			eventListener = new PixiMouseEventListener(obj, PixiMouseEventListener.MOUSE_OUT, this.mouseOut, this);
	}
