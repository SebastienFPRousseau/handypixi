/*
|--------------------------------------------------------------------------
| MouseScrollingEventListener
|--------------------------------------------------------------------------
|
| This file defines the MouseScrollingEventListener Object.
...
const {PixiMouseEventListener} = require('./PixiMouseEventListener.js');
...
class MouseScrollingEventListener extends ScrollingEventListener
{
	/**
	 * constructor
	 * This function is used in order to build a MouseScrollingEventListener
	...
	constructor(obj, code, handle, data = {})
	{
		...
		let eventListener = new PixiMouseEventListener(obj, PixiMouseEventListener.MOUSE_OVER, this.insideObject2D, this);
			eventListener = new PixiMouseEventListener(obj, PixiMouseEventListener.MOUSE_OUT, this.outsideObject2D, this);
	}
	...
	{
		window.removeEventListener(context.getJSType(context.type), context._handle);
	} 
};
