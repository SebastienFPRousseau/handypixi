 ...
 * @type {Boolean}
 */
const { CAN_UPLOAD_SAME_BUFFER } = PIXI;
 ...
 */
const TRANSFORM_MODES = PIXI.TRANSFORM_MODE;
...
class Settings {
  ...
  static autoDetectRenderer(
    ...
    if (
      ...
      {}.toString.call(options.transparent) !== "[object Boolean]"
    ) {
    ...
    if (
      ...
      {}.toString.call(options.antialias) !== "[object Boolean]"
    ) {
    ...
    if (
      ...
      {}.toString.call(options.preserveDrawingBuffer) !== "[object Boolean]"
    ) {
    ...
    if (
      ...
      {}.toString.call(options.resolution) !== "[object Number]"
    ) {
   ...
   * GRAPHICS_CURVES
   * @getter
   * This function is a getter for the member GRAPHICS_CURVES.
   * @return {Object} Graphics curves resolution settings.
   */
  static get GRAPHICS_CURVES() {
    return PIXI.Graphics.CURVES;
  }

  /**
   * GRAPHICS_CURVES
   * @setter
   * This function is a setter for the member GRAPHICS_CURVES.
   * @param {Object} settings Graphics curves resolution settings. If adaptive flag is set to true, the resolution is calculated based on the curve's length to ensure better visual quality. Adaptive draw works with bezierCurveTo and quadraticCurveTo.
   */
  static set GRAPHICS_CURVES(settings) {
    if (!(typeof settings === "object" && {}.toString.call(settings) === "[object Object]")) {
      throw new TypeError("settings must be an object.");
    }

    if ({}.toString.call(settings.adaptive) !== "[object Boolean]") {
      throw new TypeError("settings.adaptive must be a boolean.");
    }

    if ({}.toString.call(settings.maxLength) !== "[object Number]") {
      throw new TypeError("settings.maxLength must be a number.");
    }

    if ({}.toString.call(settings.minSegments) !== "[object Number]") {
      throw new TypeError("settings.minSegments must be a number.");
    }

    if ({}.toString.call(settings.maxSegments) !== "[object Number]") {
      throw new TypeError("settings.maxSegments must be a number.");
    }

    PIXI.Graphics.CURVES = settings;
  }
  ...
  static set PRECISION_FRAGMENT(precision) {
    if (
      !(
        ...
        {}.toString.call(precision) === "[object String]"
      )
    ) {
  ...
  static set RENDER_OPTIONS(options) {
    ...
    if ({}.toString.call(options.width) !== "[object Number]") {
      throw new TypeError("options.width must be a number.");
    }

    if ({}.toString.call(options.height) !== "[object Number]") {
      throw new TypeError("options.height must be a number.");
    }

    if ({}.toString.call(options.legacy) !== "[object Boolean]") {
      throw new TypeError("options.legacy must be a boolean.");
    }
