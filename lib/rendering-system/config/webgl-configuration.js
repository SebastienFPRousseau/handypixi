...
class WebGLConfiguration extends Configuration {
   ...
   * @param {PIXI.WebGLState}  gl  The PIXI Object used by this object (sreference of the renderer's state ).
  ...
  set defaultState(defaultState) {
    if (
      Object.prototype.toString.call(defaultState) !== "[object Uint8Array]"
    ) {
