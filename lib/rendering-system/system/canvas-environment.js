...
class CanvasEnvironment extends Environment {
  ...
  constructor(dom, options = {}) {
    ...
    this._prepare = new PIXI.prepare.canvas(this._renderer); // eslint-disable-line new-cap
    ...
    if (options.tickerShared) this.ticker = Ticker.shared;
    else this.ticker = new Ticker();
  ...
  set smooth(smooth) {
    if (
      !(
        typeof smooth === "string" &&
        {}.toString.call(smooth) === "[object String]"
      )
    )
