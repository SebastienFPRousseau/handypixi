...
var Setup = function () {
   ...
   */
		...
		value: function sayHello() {
			...
			if (!(typeof type === "string" && {}.toString.call(type) === "[object String]")) throw new TypeError("type must be a string.");
   ...
   */
		...
		key: "getResolutionOfUrl",
		value: function getResolutionOfUrl(url) {
			var defaultValue = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;

			if (!(typeof url === "string" && {}.toString.call(url) === "[object String]")) throw new TypeError("url must be a string.");

			if ({}.toString.call(defaultValue) !== "[object Number]") throw new TypeError("defaultValue must be a number.");
   ...
   */
		...
		key: "getUrlFileExtension",
		value: function getUrlFileExtension(url) {
			if (!(typeof url === "string" && {}.toString.call(url) === "[object String]")) throw new TypeError("url must be a string.");
   ...
   */
		...
		key: "decomposeDataUri",
		value: function decomposeDataUri(dataUri) {
			if (!(typeof dataUri === "string" && {}.toString.call(dataUri) === "[object String]")) throw new TypeError("dataUri must be a string.");
